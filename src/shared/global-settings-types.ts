...
export type GlobalSettings = {
  ...
  /** Why: display sleep locks the screen-lock-gated SSH agent (e.g. 1Password's), breaking
   *  agent git pushes; off (default) lets the display sleep while the computer stays awake. */
