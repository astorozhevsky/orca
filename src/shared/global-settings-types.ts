...
export type GlobalSettings = {
  ...
  /** Why: display sleep locks screen-lock-gated SSH agents (1Password), breaking agent git pushes;
   *  off (default) lets the display sleep while the computer stays awake. */
